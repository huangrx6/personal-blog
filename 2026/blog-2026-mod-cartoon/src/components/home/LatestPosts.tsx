...
interface LatestPostsProps {
    posts: (Post & { category: Category | null } & { coverImage?: string | null })[];
}
            ...
            <div className="max-w-[1600px] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {(!posts || posts.length === 0) ? (
                        <div className="col-span-full py-20 text-center border-4 border-dashed border-black/10 rounded-3xl bg-gray-50">
                            <h3 className="text-3xl font-black text-black/20 mb-4">NO SIGNAL DETECTED</h3>
                            <p className="text-black/40 font-bold">还没有发布任何文章，敬请期待...</p>
                        </div>
                    ) : (
