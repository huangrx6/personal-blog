...
const Data = () => {
    return (
        <>
            <div className="about_home_data">
                <div className="about_home_title">黄 任翔
                    <svg
                        width="36"
                        height="36"
                        viewBox="0 0 48 48"
                    ...
                    <h3 className="about_home_subtitle">
                        致力于全栈开发
                    </h3>

                    <p className="about_home_description">
                        我是中国河南的一名前端和后端开发工程师。我对我的工作充满激情和奉献精神。
                    </p>

                    <a href="#about_contact" className="about_home_button">
                        打个招呼
                        <svg
